...
class Node:
	def __init__(self, grid):
		...
		self.depth = 0
		self.priorityq = self.value + self.depth
		self.order = None
		self.parent = None
		# self.H = 0
		# self.G = 0
...
def remove_elem_in_set(grid, listset):
	listset.remove(grid)
...
def aStar(start, goal):
	...
	openset.add(current)
	while openset:
		# print("----no sort openset---")
		# for i in openset:
		# 	print(i.grid)
		openset = sorted(openset, key=lambda openset:openset.value)
		# print(tmp)
		# openset = tmp.append(openset)
		# openset = tmp
		# print("----openset sorted---")
		# for i in openset:
		# 	print(i.grid)
